...
DEF_HELPER_1(test, void, tl)
DEF_HELPER_3(dump_function_call, tl, tl, tl, tl)
DEF_HELPER_4(dump_memory_read, void, tl, tl, tl, tl)
DEF_HELPER_4(dump_memory_write, void, tl, tl, tl, tl)
DEF_HELPER_3(indirect_jmp, tl, tl, tl, tl)
DEF_HELPER_3(indirect_call, tl, tl, tl, tl)
DEF_HELPER_4(branch, tl, tl, tl, tl, tl)
DEF_HELPER_1(hook_return, void, tl)
