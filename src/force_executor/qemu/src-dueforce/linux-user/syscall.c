...
/* ForceExecution Modifiction - Begin */
/*
...
*/
        ...
        if (num == __NR_exit || num == __NR_exit_group || num == __NR_execve) {
        ...
        if (num == __NR_fork || num == __NR_vfork || num == __NR_clone || num == __NR_kill || num == __NR_execve || num == __NR_unlink) ret = 0;
        else ret = do_syscall1(cpu_env, num, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
...
/* ForceExecution Modifiction - End */
