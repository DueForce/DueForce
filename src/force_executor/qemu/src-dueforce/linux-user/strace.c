...
static void
print_connect(const struct syscallname *name,
             abi_long arg0, abi_long arg1, abi_long arg2,
             abi_long arg3, abi_long arg4, abi_long arg5)
{
    print_syscall_prologue(name);
...
static void 
print_listen(const struct syscallname *name,
             abi_long arg0, abi_long arg1, abi_long arg2,
             abi_long arg3, abi_long arg4, abi_long arg5)
{
    print_syscall_prologue(name);
...
static void
print_recv(const struct syscallname *name,
             abi_long arg0, abi_long arg1, abi_long arg2,
             abi_long arg3, abi_long arg4, abi_long arg5)
{
    print_syscall_prologue(name);
...
static void
print_send(const struct syscallname *name,
             abi_long arg0, abi_long arg1, abi_long arg2,
             abi_long arg3, abi_long arg4, abi_long arg5)
{
    print_syscall_prologue(name);
...
static void
print_write(const struct syscallname *name,
             abi_long arg0, abi_long arg1, abi_long arg2,
             abi_long arg3, abi_long arg4, abi_long arg5)
{
    print_syscall_prologue(name);
...
/* PMP Modification - Begin */
    ...
    strftime(buffer, 128, "%Y-%m-%d %H:%M:%S", localtime(&now.tv_sec));
    gemu_log("%s.%03d [%ld] ", buffer, (int)(now.tv_usec/1000), syscall(__NR_gettid));
#else
    gemu_log("%d ", getpid() );
#endif
/* PMP Modification - End */
